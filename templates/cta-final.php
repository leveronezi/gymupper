<section class="bg-surface relative overflow-hidden">
  ...
  <div class="glow-orb w-[700px] h-[700px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-25" aria-hidden="true"></div>
  ...
  <div class="section-wrap relative z-10">
    <div class="max-w-[700px] mx-auto text-center stagger">
      ...
      <p class="text-xs text-muted mt-5">
        100% gratuito &nbsp;·&nbsp; Sem compromisso &nbsp;·&nbsp; Resposta em até 2 horas
      </p>
